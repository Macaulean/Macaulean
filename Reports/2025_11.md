...
We chose JSON-RPC as the core communication protocol between Lean and computer algebra systems (currently only Macaulay2) and have already implemented a minimal working example that successfully exchanges requests and responses.
...
We also took advantage for having group-coding sessions during these meetings.
This has been very beneficial for uniformizing knowledge, establishing coding conventions and generally setting up common practices.
...
In particular, the AI-for-math project involving the LMFDB seemed especially interested in our progress on proving irreducibility of polynomials.
